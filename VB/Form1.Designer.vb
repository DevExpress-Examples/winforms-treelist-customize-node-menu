...
#Region "Windows Form Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            AddHandler Me.bbEdit.ItemClick, New DevExpress.XtraBars.ItemClickEventHandler(AddressOf Me.bbEdit_ItemClick)
            ' 
            ' bbAddChild
            ' 
            ...
            AddHandler Me.bbAddChild.ItemClick, New DevExpress.XtraBars.ItemClickEventHandler(AddressOf Me.bbAddChild_ItemClick)
            ' 
            ' bbDelete
            ' 
            ...
            AddHandler Me.bbDelete.ItemClick, New DevExpress.XtraBars.ItemClickEventHandler(AddressOf Me.bbDelete_ItemClick)
            ' 
            ' treeList1
            ' 
            ...
            AddHandler Me.treeList1.PopupMenuShowing, New DevExpress.XtraTreeList.PopupMenuShowingEventHandler(AddressOf Me.treeList1_PopupMenuShowing)
            AddHandler Me.treeList1.HiddenEditor, New System.EventHandler(AddressOf Me.treeList1_HiddenEditor)
            ' 
            ' Form1
            ' 
...
#End Region
        ...
        Private bbEdit As DevExpress.XtraBars.BarButtonItem

        Private bbAddChild As DevExpress.XtraBars.BarButtonItem

        Private bbDelete As DevExpress.XtraBars.BarButtonItem
